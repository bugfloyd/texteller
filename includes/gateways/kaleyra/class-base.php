...
class Base implements TLR\Interfaces\Gateway
{
    ...
    /**
     * @var null|Kaleyra $client Kaleyra Client
     */
    private static ?Kaleyra $client = null;
    ...
    public static function get_client(): ?Kaleyra
    {
        if (self::$client && is_object(self::$client)) {
            return self::$client;
        }

        $api_key = get_option("tlr_gateway_gatewayapi_api_key", "");
        $sid = self::get_encrypted_option("tlr_gateway_gatewayapi_sid");
        $delivery_callback = get_rest_url(null, "texteller/v1/delivery/kaleyra");

        try {
	        self::$client = new Kaleyra($sid, $api_key, $delivery_callback);
        } catch ( Exception $e ) {
	        TLR\tlr_write_log(
		        "Kaleyra: Failed to initialize the client." .
		        $e->getMessage()
	        );
            return null;
        }
...
//	}
    ...
    public function register_gateway_options()
    {
        ...
        add_filter(
            "pre_update_option_tlr_gateway_gatewayapi_sid",
    ...
    public static function add_options()
    {
        self::register_section([
            "id" => "tlr_gateway_kaleyra",
            "title" => __("Kaleyra", "texteller"),
            "desc" => sprintf(
        ...
        $options = [
            [
                "id" => "tlr_gateway_gatewayapi_sid",
                "title" => __("Kaleyra SID", "texteller"),
                "page" => "tlr_gateways",
                "section" => "tlr_gateway_kaleyra",
                "desc" => __(
                    "Kaleyra SID from kaleyra.io",
                    "texteller"
                ),
                "type" => "input",
                "params" => [
            ...
            [
                "id" => "tlr_gateway_gatewayapi_api_key",
                "title" => __("Kaleyra API key", "texteller"),
                "page" => "tlr_gateways",
                "section" => "tlr_gateway_kaleyra",
                "desc" => __(
                    "Kaleyra API key acquired from kaleyra.io",
                    "texteller"
                ),
                "type" => "input",
                "params" => [
            ...
            [
                ...
                "title" => __("Kaleyra sender name", "texteller"),
                "page" => "tlr_gateways",
                "section" => "tlr_gateway_kaleyra",
                "desc" => __(
                    "The sender name of the message for GatewayAPI. 1-11 ASCII characters, spaces are not allowed.",
                    "texteller"
                ),
                "type" => "input",
                "params" => [
